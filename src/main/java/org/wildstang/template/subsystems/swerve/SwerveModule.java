...
public class SwerveModule {
    ...
    /**
     * determines if it is faster to travel towards angle at positive power (true),
     * or away from angle with negative power (false)
     * 
    ...
    public SwerveModulePosition odoPosition() {
        return new SwerveModulePosition(getPosition() * 0.0254 * 0.98,
                new Rotation2d(Math.toRadians(360 - getAngle())));
    }
}
